      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
        ...
        >
          ...
          <a
            ...
            className="ml-2 inline-flex items-center rounded-full border border-border bg-card px-3 py-2 text-sm font-medium text-foreground/85 hover:border-rose/30 hover:text-rose"
          >
            Facebook
          </a>
        </nav>
        ...
        <button
          type="button"
          className="inline-flex items-center justify-center rounded-lg border border-border bg-card p-2.5 text-foreground shadow-sm lg:hidden"
          aria-expanded={open}
